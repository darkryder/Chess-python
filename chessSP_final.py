...
class BlackQueen(Piece):		
	def __init__(self):
		super(BlackQueen,self).__init__(colour="black",type="queen",x=5,y=8,imageSource="./images/queen_b.png")
...
class WhiteQueen(Piece):		
	def __init__(self):
		super(WhiteQueen,self).__init__(colour="white",type="queen",x=5,y=1,imageSource="./images/queen.png")
...
# -------- Printing -----------
	...
	if pawnSacrificed: pawnSacrifice(selectedPiece)
